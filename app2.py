...
def app():
    ...
    st.image('https://avatars.githubusercontent.com/u/97016313?v=4', width=140)
    ...
    col1, col2, col3, col4, col5= st.columns(5)
    with col3:
        st.image('https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1644222327/cjsc5fl2ayoarslqey6w.jpg', width=145)
    ...
    col1, col2, col3, col4, col5= st.columns(5)
    with col3:
        st.image('https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1643799861/qfymwplp5pbowrpjmajy.jpg', width=130)
